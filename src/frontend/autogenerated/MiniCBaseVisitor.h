...
public:
  ...
  virtual std::any visitFuncArrayDims(MiniCParser::FuncArrayDimsContext *ctx) override {
    return visitChildren(ctx);
  }
  ...
  virtual std::any visitForStep(MiniCParser::ForStepContext *ctx) override {
    return visitChildren(ctx);
  }

  virtual std::any visitForItem(MiniCParser::ForItemContext *ctx) override {
    return visitChildren(ctx);
  }
